...
`link` shortcode is an alternative to [Markdown link syntax](exampleSite/content/posts/demo/basic-markdown-syntax#links). `link` shortcode can provide some other features and can be used in code blocks.

{{< version 0.2.10 >}} The complete usage of [local resource references](exampleSite/content/posts/demo/theme-documentation-content#contents-organization) is supported.
...
* **light-style** *[optional]* (**fifth** positional parameter)
    ...
    Style for the light theme, default value is the value set in the [front matter](exampleSite/content/posts/demo/theme-documentation-content#front-matter) or the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).

* **dark-style** *[optional]* (**sixth** positional parameter)

    Style for the dark theme, default value is the value set in the [front matter](exampleSite/content/posts/demo/theme-documentation-content#front-matter) or the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).

* **navigation** *[optional]*

    Whether to add [NavigationControl](https://docs.mapbox.com/mapbox-gl-js/api#navigationcontrol), default value is the value set in the [front matter](exampleSite/content/posts/demo/theme-documentation-content#front-matter) or the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).

* **geolocate** *[optional]*

    Whether to add [GeolocateControl](https://docs.mapbox.com/mapbox-gl-js/api#geolocatecontrol), default value is the value set in the [front matter](exampleSite/content/posts/demo/theme-documentation-content#front-matter) or the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).

* **scale** *[optional]*

    Whether to add [ScaleControl](https://docs.mapbox.com/mapbox-gl-js/api#scalecontrol), default value is the value set in the [front matter](exampleSite/content/posts/demo/theme-documentation-content#front-matter) or the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).

* **fullscreen** *[optional]*

    Whether to add [FullscreenControl](https://docs.mapbox.com/mapbox-gl-js/api#fullscreencontrol), default value is the value set in the [front matter](exampleSite/content/posts/demo/theme-documentation-content#front-matter) or the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
