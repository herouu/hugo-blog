...
If you want to know about the extented Markdown syntax of **LoveIt** theme, please read [extended Markdown syntax page](exampleSite/content/posts/demo/theme-documentation-content#extended-markdown-syntax).
{{< /admonition >}}
...
{{< admonition tip >}}
**LoveIt** theme has [special shortcode for image](exampleSite/content/posts/demo/theme-documentation-extended-shortcodes#image), which provides more features.
{{< /admonition >}}
