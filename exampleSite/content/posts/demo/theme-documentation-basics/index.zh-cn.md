...
![基本配置下的预览](exampleSite/content/posts/demo/theme-documentation-basics/basic-configuration-preview.zh-cn.png "基本配置下的预览")
...
![完整配置下的预览](exampleSite/content/posts/demo/theme-documentation-basics/complete-configuration-preview.zh-cn.png "完整配置下的预览")
...
![语言切换](exampleSite/content/posts/demo/theme-documentation-basics/language-switch.gif "语言切换")
