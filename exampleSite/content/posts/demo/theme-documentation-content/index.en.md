...
It is necessary only if the front matters and the `page` part in your [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) are inconsistent.
{{< /admonition >}}
...
* **date**: the datetime assigned to this page, which is usually fetched from the `date` field in front matter, but this behaviour is configurabl in the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
...
* **toc**: {{< version 0.2.9 changed >}} the same as the `params.page.toc` part in the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
* **code**: {{< version 0.2.0 >}} the same as the `params.page.code` part in the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
* **math**: {{< version 0.2.0 changed >}} the same as the `params.page.math` part in the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
* **mapbox**: {{< version 0.2.0 >}} the same as the `params.page.mapbox` part in the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
* **share**: the same as the `params.page.share` part in the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
* **comment**: {{< version 0.2.0 changed >}} the same as the `params.page.comment` part in the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
* **library**: {{< version 0.2.7 >}} the same as the `params.page.library` part in the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
* **seo**: {{< version 0.2.10 >}} the same as the `params.page.seo` part in the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
...
![Summary Preview](exampleSite/content/posts/demo/theme-documentation-content/summary.png "Summary Preview")

### Automatic Summary Splitting

By default, Hugo automatically takes the first 70 words of your content as its summary.

You may customize the summary length by setting `summaryLength` in the [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).

If you are creating content in a [CJK]^(Chinese/Japanese/Korean) language and want to use Hugo’s automatic summary splitting, set `hasCJKLanguage` to `true` in your [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
...
Set the property `enable = true` under `[params.math]` in your [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration)
...
{{< admonition tip >}}
You can add more block and inline delimiters in your [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration).
{{< /admonition >}}
...
Set the property `copyTex = true` under `[params.math]` in your [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) to enable Copy-tex.
...
Set the property `mhchem = true` under `[params.math]` in your [site configuration](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) to enable mhchem.
