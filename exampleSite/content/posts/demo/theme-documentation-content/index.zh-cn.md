...
只有在文章的参数和你的 [网站设置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `page` 部分不一致时才有必要这么做.
{{< /admonition >}}
...
* **date**: 这篇文章创建的日期时间. 它通常是从文章的前置参数中的 `date` 字段获取的, 但是也可以在 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中设置.
* **lastmod**: 上次修改内容的日期时间.
...
* **toc**: {{< version 0.2.9 changed >}} 和 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `params.page.toc` 部分相同.
* **code**: {{< version 0.2.0 >}} 和 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `params.page.code` 部分相同.
* **math**: {{< version 0.2.0 changed >}} 和 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `params.page.math` 部分相同.
* **mapbox**: {{< version 0.2.0 >}} 和 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `params.page.mapbox` 部分相同.
* **share**: 和 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `params.page.share` 部分相同.
* **comment**: {{< version 0.2.0 changed >}} 和 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `params.page.comment` 部分相同.
* **library**: {{< version 0.2.7 >}} 和 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `params.page.library` 部分相同.
* **seo**: {{< version 0.2.10 >}} 和 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `params.page.seo` 部分相同.
...
![文章摘要预览](exampleSite/content/posts/demo/theme-documentation-content/summary.zh-cn.png "文章摘要预览")

### 自动摘要拆分

默认情况下, Hugo 自动将内容的前 70 个单词作为摘要.

你可以通过在 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中设置 `summaryLength` 来自定义摘要长度.

如果您要使用 [CJK]^(中文/日语/韩语) 语言创建内容, 并且想使用 Hugo 的自动摘要拆分功能，请在 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中将 `hasCJKLanguage` 设置为 `true`.
...
在你的 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `[params.math]` 下面设置属性 `enable = true`,
...
{{< admonition tip >}}
你可以在 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中自定义公式块和行内公式的分割符.
{{< /admonition >}}
...
在你的 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `[params.math]` 下面设置属性 `copyTex = true` 来启用 Copy-tex.
...
在你的 [网站配置](exampleSite/content/posts/demo/theme-documentation-basics#site-configuration) 中的 `[params.math]` 下面设置属性 `mhchem = true` 来启用 mhchem.
